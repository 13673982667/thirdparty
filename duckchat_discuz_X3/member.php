...
if($_GET['from'] == "duckchat" || (isset($_COOKIE['duckchat']) && $_COOKIE['duckchat'] == "duckchat")) {
    require libfile('function/member_duckchat');
    require libfile('class/member_duckchat');
    runhooks();
    setcookie("duckchat","duckchat");
    require DISCUZ_ROOT.'./source/module/duckchat_member/member_'.$mod.'.php';
} else {
